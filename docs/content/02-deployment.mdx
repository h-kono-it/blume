...
- redirect pages
- prerendered [Open Graph images](/guides/open-graph) when `og.enabled` is on
...
request-time features — most notably the [Ask AI](/guides/ai) endpoint:
...
API key. See the [AI guide](/guides/ai) for setup.
:::
